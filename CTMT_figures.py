...
def violin_add_laminae(ax):
    ...
    ax.axvspan(1.8, 2.4, facecolor='g', alpha=1, edgecolor='none')
    ax.axvspan(5.2, 6.1, facecolor='g', alpha=1, edgecolor='none')
    ax.axvspan(7.9, 11.0, facecolor='g', alpha=1, edgecolor='none')
