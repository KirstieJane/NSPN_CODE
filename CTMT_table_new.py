...
def f_p(x):
    ...
    return p
#==============================================================================
# Define your latex header and footer
#==============================================================================

latex_header = '\n'.join([ '\\documentclass{article}', 
                            '\\usepackage{booktabs}', 
                            '\\usepackage[a4paper, total={6in, 8in}, landscape]{geometry}',
...
#==============================================================================
# Create a data frame that contains all the values from measure_dict
# that you'd like to present for each of the 308 regions
#==============================================================================
...
table_dict['Lobe'] = measure_dict['lobes']
format_dict['Lobe'] = s
align_title_dict['Lobe'] = 'c'
align_col_dict['Lobe'] = 'l'

table_dict['Region'] = [ x.split('_')[1] for x in measure_dict['aparc_names'] ]
format_dict['Region'] = s
align_title_dict['Region'] = 'c'
align_col_dict['Region'] = 'l'

table_dict['Hemi'] = measure_dict['hemi']
format_dict['Hemi'] = s
align_title_dict['Hemi'] = 'c'
align_col_dict['Hemi'] = 'r'

table_dict['SubRegion'] = [ x.split('part')[-1] for x in measure_dict['aparc_names'] ]
format_dict['SubRegion'] = i
align_title_dict['SubRegion'] = 'r'
align_col_dict['SubRegion'] = 'r'

table_dict['CT at 14 (mm)'] = measure_dict['CT_all_slope_age_at14']
format_dict['CT at 14 (mm)'] = f_dp2_exp_0
align_title_dict['CT at 14 (mm)'] = 'C{1.5cm}'
align_col_dict['CT at 14 (mm)'] = 'R{1.5cm}'

table_dict['$\\Delta$CT (mm/year) $\\times10^{-3}$'] = measure_dict['CT_all_slope_age'] * 1000
format_dict['$\\Delta$CT (mm/year) $\\times10^{-3}$'] = f_dp2_exp_0
align_title_dict['$\\Delta$CT (mm/year) $\\times10^{-3}$'] = 'C{1.5cm}'
align_col_dict['$\\Delta$CT (mm/year) $\\times10^{-3}$'] = 'R{1.5cm}'

table_dict['$\\Delta$CT P'] = measure_dict['CT_all_slope_age_p']
format_dict['$\\Delta$CT P'] = f_p
align_title_dict['$\\Delta$CT P'] = 'C{1.5cm}'
align_col_dict['$\\Delta$CT P'] = 'R{1.5cm}'

table_dict['MT at 14 (AU)'] = measure_dict['CT_all_slope_age_at14']
format_dict['MT at 14 (AU)'] = f_dp2_exp_0
align_title_dict['MT at 14 (AU)'] = 'C{1.5cm}'
align_col_dict['MT at 14 (AU)'] = 'R{1.5cm}'

table_dict['$\\Delta$MT (AU/year) $\\times10^{-3}$'] = measure_dict['MT_projfrac+030_all_slope_age'] * 1000
format_dict['$\\Delta$MT (AU/year) $\\times10^{-3}$'] = f_dp2_exp_0
align_title_dict['$\\Delta$MT (AU/year) $\\times10^{-3}$'] = 'C{1.5cm}'
align_col_dict['$\\Delta$MT (AU/year) $\\times10^{-3}$'] = 'R{1.5cm}'

table_dict['$\\Delta$MT P'] = measure_dict['MT_projfrac+030_all_slope_age_p']
format_dict['$\\Delta$MT P'] = f_p
align_title_dict['$\\Delta$MT P'] = 'C{1.5cm}'
align_col_dict['$\\Delta$MT P'] = 'R{1.5cm}'

#==============================================================================
# Put this dictionary into a pandas data frame
#==============================================================================
table_df = pd.DataFrame(table_dict)

table_df.sort(columns=['$\\Delta$MT (AU/year) $\\times10^{-3}$'], 
                inplace=True,
                ascending=False)

col_list = ['Lobe', 'Region', 
            'Hemi', 'SubRegion', 
            'CT at 14 (mm)', '$\\Delta$CT (mm/year) $\\times10^{-3}$', '$\\Delta$CT P',
            'MT at 14 (AU)', '$\\Delta$MT (AU/year) $\\times10^{-3}$', '$\\Delta$MT P']


#==============================================================================
# Save the data frame as a latex string in the output file
#==============================================================================
formatters = [ format_dict[col] for col in col_list ]
...
# Adjust the header alignments
titles_list, lineend = [ x.split('&')  for x in latex_table_list[2].rsplit(' ',1) ]
titles_list = [ '\\multicolumn{{1}}{{{}}}{{{}}}'.format(align_title_dict[x.strip()], x.strip()) for x in titles_list ]
latex_table_list[2] = ' & '.join(titles_list)
latex_table_list[2] = ' '.join([latex_table_list[2], lineend[0]])          
latex_table = '\n'.join(latex_table_list)
